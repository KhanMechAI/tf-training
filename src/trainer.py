...
class Trainer:
    ...
    def __init__(self,
        ...
        self.train_summary_writer = tf.summary.create_file_writer(str(self.train_log_path))
        self.test_summary_writer = tf.summary.create_file_writer(str(self.test_log_path))
    ...
    def _get_loss_object(self, loss_type: str, loss_kwargs: Dict) -> tf.losses.Loss:
